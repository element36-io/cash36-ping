Kyc = {
  getAPIUserId: () => { return  $("#APIId")[0].value },
  getAPIPassword: function () {  return $("#APIPwd")[0].value },
  getClue: function () {  return "abc" },
  getBaseUrl: function() { return "http://localhost:8089"},
